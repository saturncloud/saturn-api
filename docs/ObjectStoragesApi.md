# saturn_api.ObjectStoragesApi

All URIs are relative to *http://localhost*

Method | HTTP request | Description
------------- | ------------- | -------------
[**cancel_upload**](ObjectStoragesApi.md#cancel_upload) | **DELETE** /api/object_storage/upload/{object_storage_upload_id} | Cancel object storage upload
[**complete_upload**](ObjectStoragesApi.md#complete_upload) | **POST** /api/object_storage/upload/{object_storage_upload_id} | Complete object storage upload
[**delete**](ObjectStoragesApi.md#delete) | **DELETE** /api/object_storage/delete | Delete object storage
[**delete_bulk**](ObjectStoragesApi.md#delete_bulk) | **DELETE** /api/object_storage/bulk_delete | Delete multiple object storage
[**download**](ObjectStoragesApi.md#download) | **POST** /api/object_storage/download | Create presigned download URL for a file
[**download_bulk**](ObjectStoragesApi.md#download_bulk) | **POST** /api/object_storage/bulk_download | Create presigned download URLs for multiple files
[**get_usage**](ObjectStoragesApi.md#get_usage) | **GET** /api/object_storage/usage | Get object storage usage stats
[**list**](ObjectStoragesApi.md#list) | **GET** /api/object_storage | List object storages
[**list_shared**](ObjectStoragesApi.md#list_shared) | **GET** /api/object_storage/shared | List owners that have shared object storage accessible to the given owner
[**list_uploads**](ObjectStoragesApi.md#list_uploads) | **GET** /api/object_storage/upload | List object storage uploads
[**resume_upload**](ObjectStoragesApi.md#resume_upload) | **GET** /api/object_storage/upload/{object_storage_upload_id} | Resume object storage upload
[**upload**](ObjectStoragesApi.md#upload) | **POST** /api/object_storage/upload | Create object storage upload
...
async with saturn_api.ApiClient(configuration) as api_client:
    ...
    api_instance = saturn_api.ObjectStoragesApi(api_client)
    ...
    try:
        ...
        print("Exception when calling ObjectStoragesApi->cancel_upload: %s\n" % e)
```
...
async with saturn_api.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling ObjectStoragesApi->complete_upload: %s\n" % e)
```
...
async with saturn_api.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling ObjectStoragesApi->delete: %s\n" % e)
```
...
async with saturn_api.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of ObjectStoragesApi->delete_bulk:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ObjectStoragesApi->delete_bulk: %s\n" % e)
```
...
Create presigned download URL for a file
...
async with saturn_api.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of ObjectStoragesApi->download:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ObjectStoragesApi->download: %s\n" % e)
```
...
async with saturn_api.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of ObjectStoragesApi->download_bulk:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ObjectStoragesApi->download_bulk: %s\n" % e)
```
...
async with saturn_api.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of ObjectStoragesApi->get_usage:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ObjectStoragesApi->get_usage: %s\n" % e)
```
...
async with saturn_api.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of ObjectStoragesApi->list:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ObjectStoragesApi->list: %s\n" % e)
```
...
async with saturn_api.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of ObjectStoragesApi->list_shared:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ObjectStoragesApi->list_shared: %s\n" % e)
```
...
async with saturn_api.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of ObjectStoragesApi->list_uploads:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ObjectStoragesApi->list_uploads: %s\n" % e)
```
...
async with saturn_api.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of ObjectStoragesApi->resume_upload:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ObjectStoragesApi->resume_upload: %s\n" % e)
```
...
async with saturn_api.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of ObjectStoragesApi->upload:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ObjectStoragesApi->upload: %s\n" % e)
```
