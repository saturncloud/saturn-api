...
class ObjectStorageList(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "dirs": (
                    [ObjectStorageDirDetails.from_dict(_item) for _item in obj["dirs"]]
                    if obj.get("dirs") is not None
                    else None
                ),
                "files": (
                    [ObjectStorageFileDetails.from_dict(_item) for _item in obj["files"]]
