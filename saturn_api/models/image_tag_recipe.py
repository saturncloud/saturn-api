...
class ImageTagRecipe(BaseModel):
    """
    ImageTagRecipe
    """ # noqa: E501
    name: StrictStr
    ...
    build_data: Optional[Dict[str, StrictStr]] = None
    __properties: ClassVar[List[str]] = ["name", "image_uri", "description", "archived", "build_data"]
