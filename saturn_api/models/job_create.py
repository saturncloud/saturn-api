...
class JobCreate(BaseModel):
    ...
    cron_schedule_options: Optional[CronScheduleCreate] = None
    __properties: ClassVar[List[str]] = ["name", "owner", "description", "tags", "instance_size", "image_uri", "image_tag_id", "image_enforce_trusted", "environment_variables", "external_repo_attachments", "extra_packages", "start_script", "working_dir", "is_spot", "start_dind", "command", "scale", "cron_schedule_options"]
