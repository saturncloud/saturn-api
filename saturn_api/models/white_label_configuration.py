...
class WhiteLabelConfiguration(BaseModel):
    ...
    brand_short_name: Optional[StrictStr] = Field(default=None, description="Short version of the brand name.")
    logo_mode: Optional[StrictStr] = Field(default='icon_and_text', description="Logo display mode: 'icon_and_text' or 'logo_only'.")
    ...
    cloud_display_names: Optional[Dict[str, StrictStr]] = Field(default=None, description="Map of cloud provider IDs to display names (e.g. {'nebius': 'My Cloud'}).")
    cloud_icon_urls: Optional[Dict[str, StrictStr]] = Field(default=None, description="Map of cloud provider IDs to icon URLs.")
    ...
    __properties: ClassVar[List[str]] = ["enabled", "brand_name", "brand_short_name", "logo_mode", "logo_icon_url", "logo_full_url", "favicon_url", "primary_color", "cloud_display_names", "cloud_icon_urls", "support_email", "website_url", "docs_url"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "logo_mode": obj.get("logo_mode") if obj.get("logo_mode") is not None else 'icon_and_text',
