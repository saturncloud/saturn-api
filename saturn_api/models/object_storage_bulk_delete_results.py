...
class ObjectStorageBulkDeleteResults(BaseModel):
    """
    ObjectStorageBulkDeleteResults
    """ # noqa: E501
    failed_file_paths: List[StrictStr] = Field(description="List of file paths that failed to delete.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "failed_file_paths": obj.get("failed_file_paths")
        })
        return _obj
