...
class ActiveResourceList(BaseModel):
    """
    ActiveResourceList
    """  # noqa: E501

    resources: List[Resource] = Field(description="List of resources that are currently active.")
    ...
    __properties: ClassVar[List[str]] = ["resources", "prev_key", "next_key"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "resources": (
                    [Resource.from_dict(_item) for _item in obj["resources"]]
