...
class PodRuntimeSummaryList(BaseModel):
    ...
    pod_summaries: List[PodRuntimeSummary] = Field(description="List of pod summaries.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "pod_summaries": (
                    [PodRuntimeSummary.from_dict(_item) for _item in obj["pod_summaries"]]
                    if obj.get("pod_summaries") is not None
                    else None
                ),
