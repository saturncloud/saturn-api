...
class ImageTagUpdate(BaseModel):
    ...
    ImageTagUpdate
    """ # noqa: E501
    description: Optional[StrictStr] = Field(default=None, description="Description of the image tag.")
    version: Optional[StrictStr] = Field(default=None, description="Version of the image tag.")
    archived: Optional[StrictBool] = Field(default=None, description="Archive the image tag. Archived tags are not attachable to new resources, but will continue to work on existing resources.")
