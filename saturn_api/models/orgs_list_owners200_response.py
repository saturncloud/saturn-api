...
ORGSLISTOWNERS200RESPONSE_ONE_OF_SCHEMAS = ["OwnerDetailedList", "OwnerList"]

T = TypeVar("T", OwnerDetailedList, OwnerList, default=Union[OwnerDetailedList, OwnerList])

class OrgsListOwners200Response(RootModel[T]):
    """
