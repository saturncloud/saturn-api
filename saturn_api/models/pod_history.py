...
class PodHistory(BaseModel):
    ...
    label_job_name: Optional[StrictStr] = Field(default=None, description="Job label, if applicable.")
    __properties: ClassVar[List[str]] = ["pod_name", "status", "last_seen", "start_time", "label_job_name"]
