...
IMAGETAGCREATE_ONE_OF_SCHEMAS = ["ImageTagCreateBuild", "ImageTagCreateExternal"]

T = TypeVar("T", ImageTagCreateBuild, ImageTagCreateExternal, default=Union[ImageTagCreateBuild, ImageTagCreateExternal])

class ImageTagCreate(RootModel[T]):
    """
    ImageTagCreate
    """
