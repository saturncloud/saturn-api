...
class ObjectStorageUploadList(BaseModel):
    ...
    uploads: List[ObjectStorageUpload] = Field(description="List of object storage uploads.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "uploads": (
                    [ObjectStorageUpload.from_dict(_item) for _item in obj["uploads"]]
                    if obj.get("uploads") is not None
                    else None
                )
            }
        )
