...
class ServiceAccountEntitlementCreate(BaseModel):
    """
    ServiceAccountEntitlementCreate
    """ # noqa: E501
    service_account_id: StrictStr = Field(description="ID of the service account to entitle the identity to.")
    identity: Optional[IdentityReference] = Field(default=None, description="Reference to an identity.")
