...
USERSGET200RESPONSE_ONE_OF_SCHEMAS = ["User", "UserDetailed"]

T = TypeVar("T", User, UserDetailed, default=Union[User, UserDetailed])

class UsersGet200Response(RootModel[T]):
    """
    UsersGet200Response
    """
