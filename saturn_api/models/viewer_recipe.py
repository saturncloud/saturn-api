...
class ViewerRecipe(BaseModel):
    """
    ViewerRecipe
    """ # noqa: E501
    identity: StrictStr
    route: Optional[RouteReference] = None
    __properties: ClassVar[List[str]] = ["identity", "route"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "route": RouteReference.from_dict(obj["route"]) if obj.get("route") is not None else None
        })
        return _obj
