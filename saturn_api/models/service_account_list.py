...
class ServiceAccountList(BaseModel):
    ...
    service_accounts: List[ServiceAccount] = Field(description="List of service accounts.")
    ...
    __properties: ClassVar[List[str]] = ["service_accounts", "prev_key", "next_key"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "service_accounts": (
                    [ServiceAccount.from_dict(_item) for _item in obj["service_accounts"]]
                    if obj.get("service_accounts") is not None
                    else None
                ),
