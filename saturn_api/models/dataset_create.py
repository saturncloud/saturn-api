...
class DatasetCreate(BaseModel):
    ...
    metadata: Optional[Dict[str, Any]] = Field(
        default=None,
        description="Optional metadata blob: schema_type, description, row_count, format hints, etc. Platform treats dataset bytes as opaque — format details live here.",
    )
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({"name": obj.get("name"), "metadata": obj.get("metadata")})
        return _obj
