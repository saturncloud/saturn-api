...
class ApiTokenCreate(BaseModel):
    ...
    ApiTokenCreate
    """ # noqa: E501
    identity: Optional[IdentityReference] = Field(default=None, description="Reference to a user or group.")
    description: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default='', description="Description of what the API token is used for.")
    expires_in: Optional[StrictInt] = Field(default=None, description="Expiration of the token in seconds.")
    refresh_expires_in: Optional[StrictInt] = Field(default=None, description="Expiration of the refresh token in seconds.")
    scope: Optional[StrictStr] = Field(default=None, description="Permission scope of the token.")
    __properties: ClassVar[List[str]] = ["identity", "description", "expires_in", "refresh_expires_in", "scope"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "identity": IdentityReference.from_dict(obj["identity"]) if obj.get("identity") is not None else None,
