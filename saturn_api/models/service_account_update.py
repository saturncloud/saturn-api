...
class ServiceAccountUpdate(BaseModel):
    ...
    auto_associate: Optional[StrictBool] = Field(default=None, description="Automatically grant access to the service account for new users and groups.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "auto_associate": obj.get("auto_associate")
        })
        return _obj
