...
class Job(BaseModel):
    ...
    cron_schedule_options: Optional[CronSchedule] = Field(default=None, description="Cron schedule configuration for scheduled jobs.")
    ...
    dask_cluster: Optional[DaskClusterNested] = Field(default=None, description="Dask cluster attached to the job.")
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "owner", "command", "description", "tags", "instance_size", "image_tag", "extra_packages", "cron_schedule_options", "start_script", "environment_variables", "working_dir", "is_spot", "start_dind", "scale", "retries", "k8s_name", "require_restart", "resource_type", "size_display", "created_at", "updated_at", "last_deploy", "dask_cluster", "status", "running_count", "debug_mode", "scheduled"]
