...
class ServiceAccountEntitlement(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "created_at", "service_account", "user_id", "group_id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "service_account": ServiceAccount.from_dict(obj["service_account"]) if obj.get("service_account") is not None else None,
