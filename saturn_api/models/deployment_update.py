...
class DeploymentUpdate(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["name", "command", "description", "instance_size", "image", "image_tag_id", "image_enforce_trusted", "extra_packages", "scale", "start_script", "environment_variables", "working_dir", "start_ssh", "is_spot", "healthcheck", "subdomain", "start_dind"]
