...
RESOURCERECIPE_ONE_OF_SCHEMAS = ["DeploymentRecipe", "JobRecipe", "WorkspaceRecipe"]

T = TypeVar("T", DeploymentRecipe, JobRecipe, WorkspaceRecipe, default=Union[DeploymentRecipe, JobRecipe, WorkspaceRecipe])

class ResourceRecipe(RootModel[T]):
    """
    ResourceRecipe
    """
