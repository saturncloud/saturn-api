...
class GroupUpdate(BaseModel):
    ...
    org_admin: Optional[StrictBool] = Field(default=None, description="Enable group to take privileged actions on its org.")
    __properties: ClassVar[List[str]] = ["groupname", "description", "is_multiple_ssh_keys", "org_admin"]
