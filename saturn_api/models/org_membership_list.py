...
class OrgMembershipList(BaseModel):
    ...
    OrgMembershipList
    """ # noqa: E501
    memberships: List[OrgMemberDetailed]
    prev_key: Optional[StrictStr] = None
    next_key: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["memberships", "prev_key", "next_key"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "memberships": [OrgMemberDetailed.from_dict(_item) for _item in obj["memberships"]] if obj.get("memberships") is not None else None,
