...
class OrgMemberUpdate(BaseModel):
    ...
    OrgMemberUpdate
    """ # noqa: E501
    org_admin: Optional[StrictBool] = Field(default=None, description="Enable user to take privileged actions on the org.")
    limits_id: Optional[StrictStr] = Field(default=None, description="Usage limits ID applied to this org member. (Admin only)")
