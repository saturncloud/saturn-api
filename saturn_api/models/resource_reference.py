...
RESOURCEREFERENCE_ONE_OF_SCHEMAS = ["ResourceByDeploymentId", "ResourceByJobId", "ResourceByWorkspaceId"]

T = TypeVar("T", ResourceByDeploymentId, ResourceByJobId, ResourceByWorkspaceId, default=Union[ResourceByDeploymentId, ResourceByJobId, ResourceByWorkspaceId])

class ResourceReference(RootModel[T]):
    """
    ResourceReference
    """
