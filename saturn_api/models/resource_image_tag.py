...
class ResourceImageTag(BaseModel):
    """
    ResourceImageTag
    """ # noqa: E501
    ...
    image: Optional[ResourceImage] = None
    __properties: ClassVar[List[str]] = ["id", "version", "image_uri", "image"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "image": ResourceImage.from_dict(obj["image"]) if obj.get("image") is not None else None
        })
        return _obj
