        ...
        _obj = cls.model_validate(
            {
                ...
                "kubecluster_summary": (
                    DeploymentRuntimeSummary.from_dict(obj["kubecluster_summary"])
                    if obj.get("kubecluster_summary") is not None
                    else None
                ),
                "scheduler_summary": (
                    PodRuntimeSummary.from_dict(obj["scheduler_summary"])
                    if obj.get("scheduler_summary") is not None
                    else None
                ),
                "worker_summary": (
                    DaskWorkerSummary.from_dict(obj["worker_summary"])
                    if obj.get("worker_summary") is not None
                    else None
                ),
