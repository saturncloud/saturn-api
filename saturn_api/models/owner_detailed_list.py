...
class OwnerDetailedList(BaseModel):
    """
    OwnerDetailedList
    """ # noqa: E501
    owners: List[OwnerDetailed]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "owners": [OwnerDetailed.from_dict(_item) for _item in obj["owners"]] if obj.get("owners") is not None else None,
