...
class WorkspaceServerInfo(BaseModel):
    ...
    WorkspaceServerInfo
    """ # noqa: E501
    server_options: WorkspaceServerOptions = Field(description="Configuration options for workspaces.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "server_options": WorkspaceServerOptions.from_dict(obj["server_options"]) if obj.get("server_options") is not None else None,
