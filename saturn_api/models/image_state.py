...
class ImageState(BaseModel):
    ...
    versions: Optional[List[ImageTagState]] = None
    __properties: ClassVar[List[str]] = ["id", "action", "versions"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "versions": [ImageTagState.from_dict(_item) for _item in obj["versions"]] if obj.get("versions") is not None else None
        })
        return _obj
