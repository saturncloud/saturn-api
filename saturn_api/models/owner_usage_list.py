...
class OwnerUsageList(BaseModel):
    """
    OwnerUsageList
    """ # noqa: E501
    usage: Optional[List[OwnerUsage]] = Field(default=None, description="List of owner usage records")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "usage": [OwnerUsage.from_dict(_item) for _item in obj["usage"]] if obj.get("usage") is not None else None
        })
        return _obj
