...
class SharedFolder(BaseModel):
    ...
    editable: StrictBool = Field(description="True if the shard folder is editable by the authenticated user/group.")
    __properties: ClassVar[List[str]] = ["id", "name", "owner", "created_at", "access", "access_mode", "is_external", "editable"]
