...
class Auth0Info(BaseModel):
    ...
    disable_native_login: StrictBool = Field(description="True if native username/password login is disabled.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "disable_native_login": obj.get("disable_native_login")
        })
        return _obj
