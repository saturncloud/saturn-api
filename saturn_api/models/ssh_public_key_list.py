...
class SSHPublicKeyList(BaseModel):
    """
    SSHPublicKeyList
    """ # noqa: E501
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "ssh_public_keys": [SSHPublicKey.from_dict(_item) for _item in obj["ssh_public_keys"]] if obj.get("ssh_public_keys") is not None else None,
