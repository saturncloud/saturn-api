...
class UserOwnerList(BaseModel):
    ...
    UserOwnerList
    """ # noqa: E501
    owners: List[OwnerUserDetailed] = Field(description="List of user owners.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "owners": [OwnerUserDetailed.from_dict(_item) for _item in obj["owners"]] if obj.get("owners") is not None else None,
