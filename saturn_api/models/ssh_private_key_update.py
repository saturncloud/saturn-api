...
class SSHPrivateKeyUpdate(BaseModel):
    """
    SSHPrivateKeyUpdate
    """ # noqa: E501
    ...
    is_default: Optional[StrictBool] = Field(default=None, description="Enable SSH private key to be used for any external repositories that do not specify a key.")
