...
class NotificationSubscriptionsList(BaseModel):
    """
    NotificationSubscriptionsList
    """ # noqa: E501
    subscriptions: Optional[List[NotificationSubscription]] = None
    prev_key: Optional[StrictStr] = None
    next_key: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["subscriptions", "prev_key", "next_key"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "subscriptions": [NotificationSubscription.from_dict(_item) for _item in obj["subscriptions"]] if obj.get("subscriptions") is not None else None,
