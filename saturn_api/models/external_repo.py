...
class ExternalRepo(BaseModel):
    ...
    ssh_privatekey: Optional[SSHPrivateKeyPartial] = Field(
        default=None, description="SSH Private Key information."
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "ssh_privatekey": (
                    SSHPrivateKeyPartial.from_dict(obj["ssh_privatekey"])
                    if obj.get("ssh_privatekey") is not None
                    else None
                ),
            }
        )
