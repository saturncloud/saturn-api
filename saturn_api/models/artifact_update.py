...
class ArtifactUpdate(BaseModel):
    ...
    metadata: Optional[Dict[str, Any]] = Field(default=None, description="Updated metadata blob.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({"status": obj.get("status"), "metadata": obj.get("metadata")})
        return _obj
