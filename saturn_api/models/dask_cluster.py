...
class DaskCluster(BaseModel):
    ...
    deployment_id: Optional[StrictStr] = Field(default=None, description="Deployment ID the dask cluster is attached to.")
    job_id: Optional[StrictStr] = Field(default=None, description="Job ID the dask cluster is attached to.")
    workspace_id: Optional[StrictStr] = Field(default=None, description="Workspace ID the dask cluster is attached to.")
