...
class OrgUpdate(BaseModel):
    ...
    limits_id: Optional[StrictStr] = Field(default=None, description="Usage limits ID applied to the entire org. (Admin only)")
    locked: Optional[StrictBool] = Field(default=None, description="Lock the org. (Admin only)")
    __properties: ClassVar[List[str]] = ["email", "description", "website_url", "logo_image_url", "limits_id", "locked"]
