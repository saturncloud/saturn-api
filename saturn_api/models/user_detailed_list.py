...
class UserDetailedList(BaseModel):
    """
    UserDetailedList
    """ # noqa: E501
    users: List[UserDetailed] = Field(description="List of detailed users.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "users": [UserDetailed.from_dict(_item) for _item in obj["users"]] if obj.get("users") is not None else None,
