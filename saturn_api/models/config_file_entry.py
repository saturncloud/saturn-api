...
class ConfigFileEntry(BaseModel):
    ...
    content: StrictStr = Field(description="Content of the config file.")
    mode: Optional[StrictStr] = Field(
        default="0644", description="File mode as a 4-character octal string, e.g. '0644'."
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "mode": obj.get("mode") if obj.get("mode") is not None else "0644",
            }
        )
        return _obj
