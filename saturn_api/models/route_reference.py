...
ROUTEREFERENCE_ONE_OF_SCHEMAS = ["RouteByContainerPort", "RouteById", "RouteBySubdomain", "str"]

T = TypeVar("T", RouteByContainerPort, RouteById, RouteBySubdomain, str, default=Union[RouteByContainerPort, RouteById, RouteBySubdomain, str])

class RouteReference(RootModel[T]):
    """
    RouteReference
    """
