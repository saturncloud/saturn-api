...
class JobUpdate(BaseModel):
    ...
    cron_schedule_options: Optional[CronScheduleUpdate] = None
    __properties: ClassVar[List[str]] = ["name", "description", "tags", "image_uri", "image_tag_id", "image_enforce_trusted", "environment_variables", "external_repo_attachments", "extra_packages", "start_script", "working_dir", "instance_size", "is_spot", "start_dind", "command", "scale", "cron_schedule_options"]
