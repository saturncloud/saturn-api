...
class AuthorizationApi:
    ...
    async def get_oauth_init(
        self,
        response_type: Annotated[StrictStr, Field(description="OAuth response type. Only 'code' is supported.")],
        ...
        redirect_uri: Annotated[StrictStr, Field(description="URI for redirect with code challenge response.")],
        code_challenge_method: Annotated[Optional[StrictStr], Field(description="OAuth code challenge method.")] = None,
        state: Annotated[Optional[StrictStr], Field(description="OAuth code challenge state.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
