...
class NotificationsApi:
    ...
    async def list_subscriptions(
        self,
        topic: Annotated[Optional[StrictStr], Field(description="Filter notification subscriptions by topic.")] = None,
        user_id: Annotated[Optional[StrictStr], Field(description="Filter notification subscriptions by user ID. Defaults to authenticated user.")] = None,
        prev_key: Annotated[Optional[StrictStr], Field(description="Previous page key.")] = None,
        next_key: Annotated[Optional[StrictStr], Field(description="Next page key.")] = None,
        page_size: Annotated[Optional[Annotated[int, Field(le=1000, strict=True, ge=1)]], Field(description="Page size.")] = None,
        descending: Annotated[Optional[StrictBool], Field(description="List results in descending order.")] = None,
        ...
        :param topic: Filter notification subscriptions by topic.
        :type topic: str
        :param user_id: Filter notification subscriptions by user ID. Defaults to authenticated user.
        :type user_id: str
        :param prev_key: Previous page key.
        :type prev_key: str
        :param next_key: Next page key.
