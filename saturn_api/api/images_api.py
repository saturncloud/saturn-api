...
class ImagesApi:
    ...
    async def list(
        ...
        name: Annotated[Optional[StrictStr], Field(description="Substring matched search string on image name.")] = None,
        access: Annotated[Optional[ImageAccessLevel], Field(description="Filter images by access level.")] = None,
        supports: Annotated[Optional[StrictStr], Field(description="Filter images by supported features.")] = None,
        hardware_type: Annotated[Optional[HardwareType], Field(description="Filter images by hardware type.")] = None,
        is_base: Annotated[Optional[StrictBool], Field(description="Filter for images that are or are not base images.")] = None,
