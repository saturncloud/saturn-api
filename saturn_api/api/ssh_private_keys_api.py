...
class SshPrivateKeysApi:
    ...
    async def list(
        ...
        name: Annotated[Optional[StrictStr], Field(description="Substring matched search string on SSH private key name.")] = None,
        is_default: Annotated[Optional[StrictBool], Field(description="Filter SSH private keys by is_default.")] = None,
