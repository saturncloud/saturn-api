...
class LimitsApi:
    ...
    async def list(
        self,
        name: Annotated[Optional[StrictStr], Field(description="Substring matched search string on usage limit name.")] = None,
        org_id: Annotated[Optional[StrictStr], Field(description="Filter usage limits by org. Defaults to the default org for the current user/group.")] = None,
