...
class CurrentUserApi:
    ...
    async def list_owners_0(
        ...
        _param = self._list_owners_0_serialize(
            user_id=user_id,
            prev_key=prev_key,
            next_key=next_key,
            page_size=page_size,
    ...
    @validate_call
    async def list_owners_0_with_http_info(
        self,
        user_id: StrictStr,
        prev_key: Annotated[Optional[StrictStr], Field(description="Previous page key.")] = None,
        next_key: Annotated[Optional[StrictStr], Field(description="Next page key.")] = None,
    ...
    @validate_call
    async def list_owners_0_without_preload_content(
        self,
        user_id: StrictStr,
        prev_key: Annotated[Optional[StrictStr], Field(description="Previous page key.")] = None,
        next_key: Annotated[Optional[StrictStr], Field(description="Next page key.")] = None,
    ...
    def _list_owners_0_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/users/{user_id}/owners',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
