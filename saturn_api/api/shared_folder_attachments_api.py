...
class SharedFolderAttachmentsApi:
    ...
    async def list(
        ...
        deployment_id: Annotated[Optional[StrictStr], Field(description="Reference by deployment ID.")] = None,
        workspace_id: Annotated[Optional[StrictStr], Field(description="Reference by workspace ID.")] = None,
