...
class ImageTagsApi:
    ...
    async def list(
        self,
        image_id: StrictStr,
        version: Annotated[Optional[StrictStr], Field(description="Substring matched search string on image tag version.")] = None,
        image_uri: Annotated[Optional[StrictStr], Field(description="Substring matched search string on image tag URI.")] = None,
        is_external: Annotated[Optional[StrictBool], Field(description="Filter image tags by is_external.")] = None,
        archived: Annotated[Optional[StrictBool], Field(description="Filter images tags by archived.")] = None,
        status: Annotated[Optional[ImageBuildStatus], Field(description="Filter image tags by build status.")] = None,
        prev_key: Annotated[Optional[StrictStr], Field(description="Previous page key.")] = None,
        next_key: Annotated[Optional[StrictStr], Field(description="Next page key.")] = None,
