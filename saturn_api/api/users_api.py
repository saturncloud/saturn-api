...
class UsersApi:
    ...
    async def get(
        self,
        user_id: StrictStr,
        details: Annotated[Optional[StrictBool], Field(description="Retrive detailed user data.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param user_id: (required)
        :type user_id: str
        :param details: Retrive detailed user data.
        :type details: bool
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
    ...
    async def list(
        self,
        username: Annotated[Optional[StrictStr], Field(description="Substring matched search string on user name.")] = None,
        email: Annotated[Optional[StrictStr], Field(description="Substring matched search string on user email.")] = None,
        details: Annotated[Optional[StrictBool], Field(description="Retrieve detailed user data. (Admin only)")] = None,
