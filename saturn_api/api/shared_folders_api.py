...
class SharedFoldersApi:
    ...
    async def list(
        ...
        name: Annotated[Optional[StrictStr], Field(description="Substring matched search string on shared folder name.")] = None,
        access: Annotated[Optional[SharedFolderAccessLevel], Field(description="Filter shared folders by access level.")] = None,
