...
class GroupsApi:
    ...
    async def list(
        self,
        name: Annotated[Optional[StrictStr], Field(description="Substring matched search string on group name.")] = None,
        org_id: Annotated[Optional[StrictStr], Field(description="Org ID to query for groups. Defaults to the default org for the authenticated user.")] = None,
        all_groups: Annotated[Optional[StrictBool], Field(description="Search for all groups in the org, instead of only groups the authenticated user is a member of.")] = None,
    ...
    async def list_members(
        self,
        group_id: StrictStr,
        name: Annotated[Optional[StrictStr], Field(description="Substring matched search string on group member username.")] = None,
        prev_key: Annotated[Optional[StrictStr], Field(description="Previous page key.")] = None,
        next_key: Annotated[Optional[StrictStr], Field(description="Next page key.")] = None,
        page_size: Annotated[Optional[Annotated[int, Field(le=1000, strict=True, ge=1)]], Field(description="Page size.")] = None,
        descending: Annotated[Optional[StrictBool], Field(description="List results in descending order.")] = None,
