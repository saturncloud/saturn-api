...
class DaskClustersApi:
    ...
    @validate_call
    async def kubecluster_runtime_summary(
        self,
        dask_cluster_id: StrictStr,
        ...
        _param = self._kubecluster_runtime_summary_serialize(
            dask_cluster_id=dask_cluster_id,
            details=details,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    async def kubecluster_runtime_summary_with_http_info(
        self,
        dask_cluster_id: StrictStr,
        details: Optional[StrictBool] = None,
        _request_timeout: Union[
    ...
    @validate_call
    async def kubecluster_runtime_summary_without_preload_content(
        self,
        dask_cluster_id: StrictStr,
        details: Optional[StrictBool] = None,
        _request_timeout: Union[
    ...
    def _kubecluster_runtime_summary_serialize(
        self,
        dask_cluster_id,
        details,
        _request_auth,
    ...
    @validate_call
    async def scheduler_runtimesummary(
        self,
        dask_cluster_id: StrictStr,
        details: Optional[StrictBool] = None,
        _request_timeout: Union[
        ...
        _param = self._scheduler_runtimesummary_serialize(
            dask_cluster_id=dask_cluster_id,
            details=details,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    async def scheduler_runtimesummary_with_http_info(
        self,
        dask_cluster_id: StrictStr,
        details: Optional[StrictBool] = None,
        _request_timeout: Union[
    ...
    @validate_call
    async def scheduler_runtimesummary_without_preload_content(
        self,
        dask_cluster_id: StrictStr,
        details: Optional[StrictBool] = None,
        _request_timeout: Union[
    ...
    def _scheduler_runtimesummary_serialize(
        self,
        dask_cluster_id,
        details,
        _request_auth,
    ...
    def _stop_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/dask_clusters/{dask_cluster_id}/close',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    async def update(
        self,
        dask_cluster_id: StrictStr,
        dask_cluster_update: Optional[DaskClusterUpdate] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    @validate_call
    async def workers_runtimesummary(
        self,
        dask_cluster_id: StrictStr,
        ...
        _param = self._workers_runtimesummary_serialize(
            dask_cluster_id=dask_cluster_id,
            page=page,
            page_size=page_size,
            _request_auth=_request_auth,
    ...
    @validate_call
    async def workers_runtimesummary_with_http_info(
        self,
        dask_cluster_id: StrictStr,
        page: Optional[Annotated[int, Field(strict=True, ge=1)]] = None,
        page_size: Optional[Annotated[int, Field(le=1000, strict=True)]] = None,
    ...
    @validate_call
    async def workers_runtimesummary_without_preload_content(
        self,
        dask_cluster_id: StrictStr,
        page: Optional[Annotated[int, Field(strict=True, ge=1)]] = None,
        page_size: Optional[Annotated[int, Field(le=1000, strict=True)]] = None,
    ...
    def _workers_runtimesummary_serialize(
        self,
        dask_cluster_id,
        page,
        page_size,
