...
class SecretsApi:
    ...
    async def list(
        ...
        name: Annotated[Optional[StrictStr], Field(description="Substring matched search string on secret name.")] = None,
        access: Annotated[Optional[SecretAccessLevel], Field(description="Filter secrets by access level.")] = None,
