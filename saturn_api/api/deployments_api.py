...
class DeploymentsApi:
    ...
    async def delete(
        self,
        deployment_id: StrictStr,
        allow_active: Annotated[Optional[StrictBool], Field(description="Force delete deployment that is currently active.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    async def list(
        ...
        name: Annotated[Optional[StrictStr], Field(description="Substring matched search string on deployment name.")] = None,
        tags: Annotated[Optional[StrictStr], Field(description="Filter to deployments whose tags contain the given 'key:value' pair, e.g. 'saturn.io/kind:finetune'.")] = None,
        prev_key: Annotated[Optional[StrictStr], Field(description="Previous page key.")] = None,
        next_key: Annotated[Optional[StrictStr], Field(description="Next page key.")] = None,
