...
class ClustersApi:
    ...
    async def list(
        self,
        org_id: Annotated[Optional[StrictStr], Field(description="Filter clusters by org ID.")] = None,
        name: Annotated[Optional[StrictStr], Field(description="Substring search on cluster name.")] = None,
